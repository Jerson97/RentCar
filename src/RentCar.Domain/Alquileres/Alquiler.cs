...
public sealed class Alquiler : Entity
{
        ...
        public static Alquiler Reservar(
            Guid vehiculoId, Guid userId, DateRange duracion, DateTime fechaCreacion, PrecioDetalle precioDetalle
        )
        {
            var alquiler = new Alquiler(Guid.NewGuid(), vehiculoId, userId,duracion, precioDetalle.PrecioPorPeriodo, precioDetalle.Mantenimiento, precioDetalle.Accesorio, precioDetalle.PrecioTotal, AlquilerStatus.Reservado, fechaCreacion);
