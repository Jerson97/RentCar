...
namespace RentCar.Infrastructure.Migrations
{
    ...
    [Migration("20250429192128_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentCar.Domain.Abstractions.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RentCar.Domain.Alquileres.Alquiler", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RentCar.Domain.Reviews.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RentCar.Domain.Vehiculos.Vehiculo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RentCar.Domain.Alquileres.Alquiler", b =>
                {
                    b.HasOne("RentCar.Domain.Abstractions.User", null)
                        .WithMany()
                    ...
                    b.HasOne("RentCar.Domain.Vehiculos.Vehiculo", null)
                        .WithMany()
                    ...
                    b.OwnsOne("RentCar.Domain.Shared.Moneda", "Accesorios", b1 =>
                        {
                    ...
                    b.OwnsOne("RentCar.Domain.Shared.Moneda", "Mantenimiento", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("RentCar.Domain.Shared.Moneda", "PrecioPorPeriodo", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("RentCar.Domain.Shared.Moneda", "PrecioTotal", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("RentCar.Domain.Alquileres.DateRange", "Duracion", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("RentCar.Domain.Reviews.Review", b =>
                {
                    b.HasOne("RentCar.Domain.Alquileres.Alquiler", null)
                        .WithMany()
                        .HasForeignKey("AlquilerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("RentCar.Domain.Vehiculos.Vehiculo", b =>
                {
                    b.OwnsOne("RentCar.Domain.Vehiculos.Direccion", "Direccion", b1 =>
                        {
                    ...
                    b.OwnsOne("RentCar.Domain.Shared.Moneda", "Precio", b1 =>
                        {
                            b1.Property<Guid>("VehiculoId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
